...
const isTheRequestInArmoury = armouryWithNamesOnly.includes(odinRequest) ? true : false;
...
console.log(isTheRequestInArmoury ? "Ah, I finally found something to hammer that nail into" : "What do you want me to do with this?");
